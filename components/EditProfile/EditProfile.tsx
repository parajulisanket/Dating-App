...
const HOBBIES_OPTIONS = [
  { key: "football", label: "Football", emoji: ":football2:" },
  { key: "exercising", label: "Exercising", emoji: ":muscle:" },
  { key: "art", label: "Art", emoji: ":art:" },
  { key: "singing", label: "Singing", emoji: ":microphone:" },
            ...
            {HOBBIES_OPTIONS.map((hobby) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-[14px] flex items-center gap-2 border transition-all ${
                    isSelected
