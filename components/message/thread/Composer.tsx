      ...
      <div className="flex items-center gap-2">
        <div className="flex min-w-0 flex-1 items-center rounded-4xl bg-[#3333331A] ">
          ...
          <Textarea
            ...
            onKeyDown={onKeyDown}
            placeholder="Message"
            className="min-h-10 resize-none border-0 bg-transparent py-3 text-sm leading-5 focus:outline-none focus-visible:ring-0 placeholder:font-semibold"
          />
        ...
        {active ? (
          <Button
            onClick={sendText}
            className="h-10 w-10 rounded-full bg-gradient-to-tl from-[#F92FA2] to-[#CA2CFF] p-0 text-white hover:opacity-90"
            aria-label="Send"
          >
