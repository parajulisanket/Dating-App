          ...
          <div className="p-4">
            <div className="space-y-4">
              <div className="flex flex-col gap-1">
                ...
                >
                  Find your match faster and stand out from the crowd! Choose
                  the plan that fits your vibe and unlock exclusive features
                  made to boost your dating journey.
                </p>
              </div>
              <div className="flex flex-col gap-4">
                ...
                <div className="rounded-2xl flex flex-col justify-center items-center view-profile p-4 text-white">
                  ...
                  <p className="font-medium text-[16px] ">
                    View unmatched profiles for Rs. 200.
                  </p>
                </div>
