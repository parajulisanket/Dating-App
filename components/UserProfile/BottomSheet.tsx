  ...
  return (
    <>
      ...
      <motion.div
        ...
        className=" z-50 bottom-0 pt-[1px]  md:rounded-4xl left-0 right-0 bg-background rounded-t-3xl  h-[306px]  mx-auto no-scrollbar"
      >
        {/* User Info Header */}
        ...
        <div className="px-4 py-4 space-y-1">
          ...
          >
            <Image src="/icons/block.svg" alt="block" height={24} width={24} />
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3  rounded-lg transition-colors text-left"
          >
            <Image src="/icons/mute.svg" alt="block" height={24} width={24} />
